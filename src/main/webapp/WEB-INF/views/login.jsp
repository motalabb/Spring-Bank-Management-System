...
html, body {
	background-image:
		url('https://images.unsplash.com/photo-1610028494122-e4d902292b83?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&dl=endri-killo-kNuNN1cPhXU-unsplash.jpg');
...
<body>
	...
	<div class="container">
		<div class="d-flex justify-content-center h-100">
			<div class="card">
				<center>
					<h1 style="color:red">ISLAMI BANK</h1>
					...
					<div class="card-body">
						<form action="/sinin" method="post">
							<div class="simple-login-container">
								...
								<div class="row">
									<div class="col-md-12">
										<a href="/createAccount" class="btn btn-primary">Create
											New Account</a></th>
									</div>
								</div>
							</div>
